...
export const interviewers: Interviewer[] = [
  ...
  { id: 'marcus-vance', name: 'Marcus Vance', style: 'technical', styleLabel: 'Technical', gender: 'male', blurb: 'Interrupts abstractions and asks for the mechanism underneath.', portraitUrl: '', level: 2, locked: false },
  { id: 'elena-kovac', name: 'Elena Kovač', style: 'distracted_exec', styleLabel: 'Distracted exec', gender: 'female', blurb: 'Scanning for signal. You get one minute before she decides.', portraitUrl: '', level: 3, locked: true },
]
